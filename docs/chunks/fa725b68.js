...
function setProperty$1(prototype, initialize, attrs, prop, schema) {
  ...
  function set(nextValue) {
    let prevValue = this[ELEMENT_PROPS][prop]; // if the next value in function, with the exception of the type function or Any,
...
export { Any as A, useEffect as a, useHost as b, customElement as c, useEvent as d, createElement as e, useRef as f, render as r, useState as u };
//# sourceMappingURL=fa725b68.js.map
