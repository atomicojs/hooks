import { P, B, d, T } from './chunks/7af3821d.js';
...
const Example1 = ({
  ...
  return d("host", {
    ref: ref,
    shadowDom: true
  }, d("style", null, `:host{display:block;width:100%}img{width:100%}`), d("img", {
    src: state
  }));
};
